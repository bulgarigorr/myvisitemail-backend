...
class CampaginsService {
    constructor(customerDao, mailchimpDao, bokunDao) {
    ...
    performCampaignAction(campaignSettings, campaignListId, sendDate) {
    ...
    async getBookingsForCustomer(customer) {
        let bokunBookings = [];
        try {
...
//# sourceMappingURL=campagins.service.js.map