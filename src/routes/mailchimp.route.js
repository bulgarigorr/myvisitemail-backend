...
const mailchimp_dao_1 = require("../database/mailchimp/mailchimp.dao");
class MailchimpRoute {
    constructor() {
        ...
        this.router.post('/campaign', this.jsonParser, (req, res) => {
...
//# sourceMappingURL=mailchimp.route.js.map